...
INSERT INTO credenciales (id_usuario, username, password_hash) VALUES 
  ...
  (21, 'carlos.machique21', 'hash_carlos_machique'),
  (22, 'josue.suarez22', 'hash_josue_suarez'),
  (23, 'edgar.alonso23', 'hash_edgar_alonso'),
  (24, 'edson.zapata24', 'hash_edson_zapata'),
  (25, 'wilson.martinez25', 'hash_wilson_martinez'),
  (26, 'valeria.sanchez26', 'hash_valeria_sanchez'),
  (27, 'elizabeth.barrera27', 'hash_elizabeth_barrera'),
  (28, 'jose.rodarte28', 'hash_jose_rodarte'),
  (29, 'elsy.perez29', 'hash_elsy_perez'),
  (30, 'lucio.escobar30', 'hash_lucio_escobar'),
  (31, 'samuel.martinez31', 'hash_samuel_martinez');
